...
namespace PhysicsProjectileSimulator
{
    public class Projectile : GameComponent
    {
        ...
        public SphereProjectile cubeProjectile;
        public SphereProjectile cylinderProjectile;
        public SphereProjectile coneProjectile;
        public SphereProjectile teardropProjectile;

        public Mesh mesh;

        public Rigidbody projectileRb;
        public MeshCollider projectileMeshCollider;
        public MeshFilter projectileMeshFilter;
